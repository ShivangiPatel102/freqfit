                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          context,
                          screenTitle: "startScreen".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.startscreenScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "getStartedScreen".tr,
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "earTest".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.eartestScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "airConductScreen".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "earTestResults".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.eartestresultsScreen),
                        ),
                      ],
                    ),
                  ),
